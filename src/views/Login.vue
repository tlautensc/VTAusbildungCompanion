  ...
  <div>
    ...
    <form novalidate @submit.prevent="login">
      <md-field>
        ...
        <md-input name="email" id="email" type="email" v-model="username"/>
      </md-field>
        <md-field>
    ...
    <md-button to="/register">Registrieren</md-button>
  </div>
</template>
...
export default {
    ...
    methods: {
      async login(){
        ...
        this.$router.push(this.$route.query.redirect || '/ausbildungsnachweise')
      },
  }
